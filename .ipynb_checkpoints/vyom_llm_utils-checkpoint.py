...
def llm_prompt_generator(User_Input):
    ...
    system_role =  """
                ...
                The outputs of both Video_prompt and Image_prompt should not exceed more than 80 words
                </Important>
                <Example1>
...
class Generator_4secs:
    ...
    def __init__(self, image_prompt, video_prompt):
        self.name = "Generator"
        self.image_prompt = image_prompt
        self.video_prompt = video_prompt
        self.file_path = 'vyom_4sec_llm_list.txt'
        self.image_name = "data/test_images/vyom_4sec_llm.jpg"
        self.command = [
                    'python', 'inference.py',
...
class Generator_9secs:
    ...
    def __init__(self, image_prompt, video_prompt):
        ...
        self.image_prompt = image_prompt
        self.video_prompt = video_prompt
        self.file_path = 'vyom_9sec_llm_list.txt'
        self.image_name = "data/test_images/vyom_9sec_llm.jpg"
        self.command = [
                    'python', 'inference.py',
                    '--cfg', 'configs/i2vgen_xl_infer.yaml',
                    'test_list_path', self.file_path,
    ...
    def run_iterations(self, number_of_iterations=2):
        ...
        try:
            subprocess.run("rm -rf workspace/experiments/vyom_9sec_llm_list/")
        except:
        ...
        for i in range(number_of_iterations):
            ...
            directory = 'workspace/experiments/vyom_9sec_llm_list/'
    ...
    def combine_videos(self):
        ...
        folder_path = "workspace/experiments/vyom_9sec_llm_list"
        ...
        os.makedirs("9secs_llm_video", exist_ok=True)
        # Write the concatenated video to a file
        output_path = "9secs_llm_video/" + str(self.video_prompt[:100])+".mp4"
